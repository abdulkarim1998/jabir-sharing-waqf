...
) RETURNING id, project_id, donor_name, donor_email, donor_phone, amount, donation_type, message, recipient_name, recipient_email, recipient_phone, is_anonymous, order_id, payment_status, payment_reference, payment_transaction_id, created_date, modified_date
`
...
SELECT id, project_id, donor_name, donor_email, donor_phone, amount, donation_type, message, recipient_name, recipient_email, recipient_phone, is_anonymous, order_id, payment_status, payment_reference, payment_transaction_id, created_date, modified_date FROM donations WHERE id = $1 LIMIT 1
`
...
const GetDonationByOrderID = `-- name: GetDonationByOrderID :one
SELECT id, project_id, donor_name, donor_email, donor_phone, amount, donation_type, message, recipient_name, recipient_email, recipient_phone, is_anonymous, order_id, payment_status, payment_reference, payment_transaction_id, created_date, modified_date FROM donations WHERE order_id = $1 LIMIT 1
`

func (q *Queries) GetDonationByOrderID(ctx context.Context, orderID *string) (*Donation, error) {
	row := q.db.QueryRow(ctx, GetDonationByOrderID, orderID)
	var i Donation
	err := row.Scan(
		&i.ID,
		&i.ProjectID,
...
SELECT d.id, d.project_id, d.donor_name, d.donor_email, d.donor_phone, d.amount, d.donation_type, d.message, d.recipient_name, d.recipient_email, d.recipient_phone, d.is_anonymous, d.order_id, d.payment_status, d.payment_reference, d.payment_transaction_id, d.created_date, d.modified_date FROM donations d
...
SELECT id, project_id, donor_name, donor_email, donor_phone, amount, donation_type, message, recipient_name, recipient_email, recipient_phone, is_anonymous, order_id, payment_status, payment_reference, payment_transaction_id, created_date, modified_date FROM donations 
WHERE project_id = $1 
...
const UpdateDonationPaymentStatusByOrderID = `-- name: UpdateDonationPaymentStatusByOrderID :one
UPDATE donations SET
    payment_status = $2,
    payment_transaction_id = $3,
    modified_date = NOW()
...
type UpdateDonationPaymentStatusByOrderIDParams struct {
	OrderID              *string           `json:"order_id"`
	PaymentStatus        NullPaymentStatus `json:"payment_status"`
	PaymentTransactionID *string           `json:"payment_transaction_id"`
}

func (q *Queries) UpdateDonationPaymentStatusByOrderID(ctx context.Context, arg *UpdateDonationPaymentStatusByOrderIDParams) (*Donation, error) {
	row := q.db.QueryRow(ctx, UpdateDonationPaymentStatusByOrderID, arg.OrderID, arg.PaymentStatus, arg.PaymentTransactionID)
	var i Donation
	err := row.Scan(
		&i.ID,
		&i.ProjectID,
